...
#
# Cache Variables: CPPCHECK_EXECUTABLE
#
# Non-cache variables you might use in your CMakeLists.txt: CPPCHECK_FOUND
# CPPCHECK_POSSIBLEERROR_ARG CPPCHECK_UNUSEDFUNC_ARG CPPCHECK_STYLE_ARG
# CPPCHECK_QUIET_ARG CPPCHECK_INCLUDEPATH_ARG CPPCHECK_FAIL_REGULAR_EXPRESSION
# CPPCHECK_WARN_REGULAR_EXPRESSION CPPCHECK_MARK_AS_ADVANCED - whether to mark
# our vars as advanced even if we don't find this program.
#
# Requires these CMake modules: FindPackageHandleStandardArgs (known included
# with CMake >=2.6.2)
#
...
set(
  CPPCHECK_ROOT_DIR "${CPPCHECK_ROOT_DIR}"
...
function(_cppcheck_test_arg _resultvar _arg)
  ...
  execute_process(
    COMMAND
      "${CPPCHECK_EXECUTABLE}" "${_arg}" "--quiet" "${_cppcheckdummyfile}"
