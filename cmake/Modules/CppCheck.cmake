...
if(CPPCHECK_FOUND)
  ...
  set(_cppcheck_dirs **FILL IN DIRECTORIES THAT REQUIRE CHECKING**)
  ...
  add_custom_target(
    cppcheck
    COMMAND
      ${CPPCHECK_EXECUTABLE} ${CPPCHECK_POSSIBLEERROR_ARG}
      ${CPPCHECK_UNUSEDFUNC_ARG} ${CPPCHECK_STYLE_ARG} ${CPPCHECK_QUIET_ARG}
